...
int solopage(){
	...
	Button Back(0,20,100,40,EGERGB(0x24,0x24,0x24),EGERGB(0x17,0x17,0x17),EGERGB(0x2b,0x2b,0x2b),EGERGB(0x36,0x36,0x36),
	"BACK","Consolas",25,10,6,WHITE);
